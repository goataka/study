...
各ドリルは `guide.md`（解説・練習・解答を統合）1ファイルで構成する。
文法ドリルには穴埋め問題・解答・英作文・英作文解答をすべて `guide.md` 内に統合する。
...
contents/english/
  ...
  12-tenses-regular-past/
    guide.md          （解説・穴埋め・解答・英作文・英作文解答を統合）
  ...
```
...
2. **練習問題**: 穴埋め問題（空欄あり）
3. **解答**: 穴埋め問題の解答
4. 文法ドリルのみ：**英作文**: 日本語→英語の翻訳問題
5. 文法ドリルのみ：**英作文解答**: 英作文の解答
...
各トピックは `guide.md`（解説・練習問題・解答を統合）1ファイルで構成する。
