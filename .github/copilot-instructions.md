...
2. **エビデンスファイルをコミットに含める**
   - `quiz/TEST_EVIDENCE.md` - 最新のテスト結果の詳細
...
5. **CI でも自動更新される**
   ...
   - 両方のファイル（`TEST_EVIDENCE.md` と `TEST_EVIDENCE_LOG.md`）が自動的にコミットされる
