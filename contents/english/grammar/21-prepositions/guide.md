...
- `at`: 地点（at home, at school, at the station）
...
| 前置詞 | 用法 | 例 |
|--------|------|------|
| `at` | 地点・時刻 | `at` home / `at` 3 o'clock |
| `in` | 空間・月/季節 | `in` the park / `in` June |
| `on` | 面の上・曜日 | `on` the desk / `on` Sunday |
| `to` | 方向 | go `to` school |
| `by` | 手段 | go `by` bus |
...
[目次](../../README.md) | [練習](drill.md) | [回答](answer.md) | [英作文](writing.md) | [英作文解答](writing-answer.md) | 解説 | [クイズ](../../../quiz/index.html?subject=english&category=prepositions)
