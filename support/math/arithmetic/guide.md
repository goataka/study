...
算数の基本となる四則演算（たし算・ひき算・かけ算・わり算）と、分数・小数・比率などの計算を学びます。
...
| [分数のひき算（異分母）](fractions-diff-sub/guide) | 通分が必要な分数の引き算 |
| [分数のかけ算](fractions-multiply/guide) | 分数同士の掛け算 |
| [分数のわり算](fractions-divide/guide) | 分数同士の割り算 |
| [小数のたし算](decimals-addition/guide) | 小数点を含む足し算 |
| [小数のひき算](decimals-subtraction/guide) | 小数点を含む引き算 |
| [小数のかけ算](decimals-multiplication/guide) | 小数点を含む掛け算 |
| [比](ratio/guide) | 2つの量の比の表し方 |
| [割合（百分率）](percentage/guide) | パーセントを使った割合の計算 |

## 💡 算数学習のポイント

- **繰り上がり・繰り下がりを理解する**: 計算の基礎となる考え方
- **九九を確実に覚える**: かけ算・わり算の基礎
- **分数・小数の変換**: 分数と小数を相互に変換できるようにする
