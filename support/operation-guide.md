...
| タブ | 説明 |
|------|------|
| 🚀 ガイド | 使い方・コンテンツ・サポート情報を表示する（初回表示） |
| 🎯 おすすめ | 全教科のおすすめ単元と活動サマリを表示する（2回目以降の初期表示） |
...
| パーツ | 説明 |
|--------|------|
| 📚 今日の単元 | 学習中または未学習の単元を教科ごとに表示する |
| 目標数コントロール | おすすめ表示の目標数（3/5/8/13/21）を切り替える |
| 目標ライン | 「🎯 目標ここまで / ここから追加チャレンジ」で、目標分と追加分の境界を表示する |
| 🚀 もっと追加してチャレンジ | 目標分の下に追加のおすすめ単元を表示する |
...
| 候補ボタン | 書いた文字の認識候補を表示する。クリックすると解答欄に入力される（英語問題で候補が空の場合は正解文字列を候補表示） |
