...
| プロフィール画像を変更する | クリックするとアバター画像のトリミングダイアログを開く |
...
| パーツ | 説明 |
|--------|------|
| 教科ボタン | 各教科をクリックすると右列に進度詳細が表示される |
...
| カテゴリ別タブ | カテゴリごとにグループ化した単元の進度を表示する |
| マトリクスタブ | 単元の進度をマトリクス形式で表示する |
| 学習状況フィルター | すべて／未学習／学習中／学習済み で単元を絞り込む |
...
URLのハッシュフラグメントを使って、特定の教科やメニューに直接アクセスできます。
