...
| **最終更新** | 2026-04-21 09:26:03 JST |
| **更新者** | GitHub Actions (CI) |
| **コミット** | `bd62a25` |
| **コミットメッセージ** | Add meta-rule section for managing copilot instructions |
...
| ファイル | SHA256 |
|------|------|
| `test-results.json` | `46c9946f61115af5d7b795bbcce24b67573e65e1186db4924cc9bd35860ad042` |
