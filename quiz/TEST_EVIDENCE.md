...
| **最終更新** | 2026-04-21 09:12:55 JST |
| **更新者** | GitHub Actions (CI) |
| **コミット** | `e17993b` |
| **コミットメッセージ** | fix: ツリーで1問も解いてないときの表記を「0/10」形式に統一 |
...
| ファイル | SHA256 |
|------|------|
| `test-results.json` | `181ed624c608cce13b2b992e8372d0b41a738407f9e6a42617de9504e29a4748` |
...
### ✅ `src/presentation/quizApp.test.ts` (13/13)
...
| ✅ | QuizApp — カテゴリツリー仕様 > 1問も解いていないときの統計表示は「0/総数」の形式である |
